...
export const validateCSVData = (data: ParsedClassData): string[] => {
  ...
  if (duplicateNames.length > 0) {
    ...
    errors.push(
      `Duplicate student names found: ${uniqueDuplicates.join(', ')}. Each student must have a unique name. Please review your CSV and ensure all student names are distinct.`
    );
  }
