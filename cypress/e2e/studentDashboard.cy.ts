...
describe('Student Dashboard', () => {
  beforeEach(() => {
    cy.intercept('GET', '**/api/student/dashboard*', { fixture: 'student_dashboard.json' }).as('studentDashboard');
  ...
  it('allows retry after error', () => {
    ...
    cy.intercept('GET', '**/api/student/dashboard*', { fixture: 'student_dashboard.json' }).as('studentDashboardRetry');
